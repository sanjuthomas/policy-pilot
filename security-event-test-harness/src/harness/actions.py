...
def repair_authorization(settings: Settings) -> HarnessActionResult:
    ...
    try:
        response = httpx.post(url, params={"limit": 500}, timeout=120.0)
    ...
    try:
        republish = httpx.post(republish_url, params={"limit": 500}, timeout=120.0)
    except httpx.HTTPError as exc:
