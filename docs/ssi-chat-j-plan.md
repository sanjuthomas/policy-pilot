...
| Success bar | Golden eval green on `:8096` | Bank now **100** cases under `ssi-chat-j/eval/` |
...
Cases: [`ssi-chat-j/eval/eligibility_golden.yaml`](../ssi-chat-j/eval/eligibility_golden.yaml) (**100**). See [`ssi-chat-j/eval/README.md`](../ssi-chat-j/eval/README.md).
