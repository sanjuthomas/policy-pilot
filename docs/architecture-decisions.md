...
The root [README](../README.md#neo4j-graph-model) keeps the four sub-graph diagrams and example Cypher. See also `neo4j-graph-model/` for the full property catalog.
