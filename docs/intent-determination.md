...
HTTP black-box bank: [`ssi-chat-j/eval/eligibility_golden.yaml`](../ssi-chat-j/eval/eligibility_golden.yaml) (**99** cases). Prove: `./ssi-chat-j/scripts/prove-eligibility.sh`.
