...
Demo personas and seed users: **[Domain models and demo users](domain-models.md)**. Automated golden bank: **[ssi-chat-j/eval/eligibility_golden.yaml](../ssi-chat-j/eval/eligibility_golden.yaml)** (**103** cases).
