...
IDS="${ELIGIBILITY_GOLDEN_IDS:-golden_policies_eligible_approvers_payment,golden_policies_eligible_submitters_payment,golden_policies_eligible_approvers_instruction,golden_policies_amount_club_directory}"
